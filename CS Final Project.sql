...
-- DROP DATABASE IF EXISTS "CS Final Project";

CREATE DATABASE "CS Final Project"
    WITH
    OWNER = postgres
    ENCODING = 'UTF8'
...
CREATE TABLE Borrow (
	...
	CHECK (Borrow_Date <= CURRENT_DATE AND Due_Date >= Borrow_Date AND Return_Date >= Borrow_Date)
);
...
/*inserting_Values_into_the_Tables*/
